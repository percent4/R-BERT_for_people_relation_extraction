...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_file", default="rbert_train.csv", type=str, help="Train file")
    parser.add_argument("--test_file", default="rbert_test.csv", type=str, help="Test file")
